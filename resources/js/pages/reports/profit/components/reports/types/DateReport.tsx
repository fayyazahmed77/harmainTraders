...
const DateReport: React.FC<Props> = ({ data, formatCurrency }) => {
    return (
        <>
            <TableHeader>
                <TableRow className="border-border/50 hover:bg-transparent">
                    <TableHead className="text-[9px] font-black text-text-muted uppercase h-10">Date</TableHead>
                    <TableHead className="text-[9px] font-black text-text-muted uppercase h-10 text-right">Revenue</TableHead>
                    <TableHead className="text-[9px] font-black text-text-muted uppercase h-10 text-right">COGS</TableHead>
                    <TableHead className="text-[9px] font-black text-text-muted uppercase h-10 text-right">Profit</TableHead>
                    <TableHead className="text-[9px] font-black text-text-muted uppercase h-10 text-center w-[100px]">Margin %</TableHead>
                </TableRow>
            </TableHeader>
            <TableBody>
                {data.map((row, idx) => (
