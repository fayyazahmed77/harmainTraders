...
export function ParameterForm({ 
    ...
    // Filtered geo options based on parent selection
                                ...
                                <div className="space-y-6 lg:col-span-2">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                        <div className="space-y-2">
                                            <Label className="text-[9px] font-black text-indigo-600/60 uppercase tracking-widest ml-1">Province</Label>
                                            <SearchableSelect 
                                        ...
                                        <div className="space-y-2">
                                            <Label className="text-[9px] font-black text-indigo-600/60 uppercase tracking-widest ml-1">City</Label>
                                            <SearchableSelect 
