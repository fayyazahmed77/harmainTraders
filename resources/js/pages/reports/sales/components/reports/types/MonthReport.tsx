                        ...
                        >
                            <div className="flex items-center gap-8">
                                <div className="flex items-center gap-4">
                                    <div className={cn(
                                        ...
                                        isExpanded ? "bg-indigo-600/10 text-indigo-600 rotate-180" : "bg-text-muted/10 text-text-muted"
                                    )}>
                                        <ChevronDown className="h-5 w-5" />
                                    </div>
                                    <div className="flex flex-col">
                                        <span className="text-[9px] font-black text-text-muted/60 uppercase tracking-widest">Month Name</span>
                                        <span className="text-xl font-black italic tracking-tighter text-indigo-600 dark:text-indigo-400 uppercase leading-tight">{month.name}</span>
                                    </div>
                                </div>
                            ...
                            <div className="flex items-center gap-8">
                                ...
                                <div className={cn(
                                    ...
                                    isExpanded ? "bg-rose-500 text-white" : "bg-indigo-500/10 text-indigo-500"
                                )}>
