                                ...
                                <div className="space-y-6 lg:col-span-3">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                        <div className="space-y-2">
                                            <Label className="text-[9px] font-black text-emerald-500/60 uppercase tracking-widest ml-1">Province</Label>
                                            <SearchableSelect 
                                        ...
                                        <div className="space-y-2">
                                            <Label className="text-[9px] font-black text-emerald-500/60 uppercase tracking-widest ml-1">City</Label>
                                            <SearchableSelect 
