...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: "Sales Return Reports", href: "/reports/sales-return" },
];

export default function SalesReturnReport({ customers }: Props) {
    const [dateRange, setDateRange] = useState<DateRange | undefined>({
        from: subDays(new Date(), 30),
        to: new Date(),
    });
    const [data, setData] = useState<SalesReturnData | null>(null);
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            const response = await axios.get(route('reports.sales-return'), {
                params: {
            ...
            toast.error("Failed to load sales return report");
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <>
            <Head title="Sales Return Reports" />
            <SidebarProvider>
                <AppSidebar />
                <SidebarInset>
                    ...
                    <div className="p-6 space-y-6  min-h-screen">
                        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                            <div>
                                <h1 className="text-3xl font-bold tracking-tight ">Sales Return Reports</h1>
                                <p className="text-slate-500">Track and analyze sales returns</p>
                            </div>
                            <div className="flex items-center gap-2">
                                ...
                                <ButtonGroup>
                                    ...
                                    >
                                        <a
                                            href={route("reports.sales-return.export.pdf", {
                                                from: dateRange?.from ? format(dateRange.from, "yyyy-MM-dd") : null,
                                                to: dateRange?.to ? format(dateRange.to, "yyyy-MM-dd") : null,
                                                customer_id: selectedCustomer !== "all" ? selectedCustomer : null,
                                            })}
                                    ...
                                    >
                                        <a
                                            href={route("reports.sales-return.export.excel", {
                                                from: dateRange?.from ? format(dateRange.from, "yyyy-MM-dd") : null,
                                                to: dateRange?.to ? format(dateRange.to, "yyyy-MM-dd") : null,
                                                customer_id: selectedCustomer !== "all" ? selectedCustomer : null,
                                            })}
                        ...
                        <div className="grid gap-6 md:grid-cols-2">
                            ...
                            <ChartCard title="Top 10 Customers by Returns">
                                <div className="h-[300px] w-full">
                                    <ResponsiveContainer width="100%" height="100%">
                        ...
                        <Card className="shadow-sm">
                            <CardHeader>
                                ...
                                <CardDescription>Detailed sales return records</CardDescription>
                                <div className="mt-4">
