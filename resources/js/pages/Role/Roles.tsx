                        ...
                        <form onSubmit={handleSubmit} className="w-full">
                            <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 md:p-8 shadow-sm space-y-6">
                                ...
                                <div className="space-y-1">
                                    <h2 className="text-xl font-bold text-zinc-900 dark:text-zinc-100">Add new Role</h2>
                                    <p className="text-sm text-zinc-500 dark:text-zinc-400">Create a new role and assign permissions.</p>
                                </div>
