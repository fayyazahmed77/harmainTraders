...
export const SuccessDialog: React.FC<SuccessDialogProps> = ({
  ...
  const handleDirectPrint = (format: 'small' | 'big') => {
    ...
    iframe.src = `/sales-return/${saleId}/pdf?format=${format}`;
          ...
          <div className="p-8 text-center flex flex-col items-center justify-center space-y-6 min-h-[350px] bg-[#0A0B10] text-white">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-zinc-400 font-medium px-4">
                Directing Sales Return #{invoiceNo} layout payload to {printFormat === 'big' ? 'A4' : 'thermal'} output stream.
              </p>
            </div>
            ...
            <div className="p-8 space-y-6">
               ...
               <div className="flex justify-between items-end">
                  ...
                  <div className="flex flex-col items-end gap-1">
                     <span className="text-[10px] font-black text-zinc-500 uppercase tracking-widest">Credit Amount</span>
               ...
               <div className="grid grid-cols-2 gap-3 pt-2">
                  ...
                  <Button 
                    onClick={() => window.open(`/sales-return/${saleId}/show`, '_blank')}
                    variant="outline" 
