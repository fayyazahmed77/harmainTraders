...
export default function Purchase({
    ...
    // Global Keyboard Shortcuts (F4 / Alt+C -> Payment Settlement Dialog, F9 / Ctrl+Enter -> Confirm & Save)
    useEffect(() => {
        const handleKeyDown = (e: KeyboardEvent) => {
            ...
            // F9 or Ctrl+Enter (when dialog not open): Confirm & Save
                                        ...
                                        <div className="pt-2 flex flex-col gap-2">
                                            <div className="flex items-center justify-between p-3 rounded-sm bg-orange-500/5 border border-orange-500/10 transition-all hover:bg-orange-500/10 group cursor-pointer" onClick={() => {
                                                ...
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div className="flex flex-col">
                                                        <span className="text-[10px] font-black uppercase tracking-widest text-zinc-900 dark:text-zinc-100 flex items-center gap-1.5">
