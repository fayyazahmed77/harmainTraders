...
export const SuccessDialog: React.FC<SuccessDialogProps> = ({
  ...
  const handleDirectPrint = (format: 'small' | 'big') => {
    ...
    iframe.src = `/purchase-return/${saleId}/pdf?format=${format}`;
        ...
        {isPrinting ? (
          <div className="p-8 text-center flex flex-col items-center justify-center space-y-6 min-h-[350px] bg-[#0A0B10] text-white">
            <div className="relative flex items-center justify-center mt-4">
              <div className="animate-ping absolute inline-flex h-20 w-20 rounded-full bg-[#F97316] opacity-20"></div>
              <div className="relative rounded-full bg-[#F97316]/10 p-6 text-[#F97316] border border-[#F97316]/20">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-zinc-400 font-medium px-4">
                Directing Purchase Return #{invoiceNo} layout payload to {printFormat === 'big' ? 'A4' : 'thermal'} output stream.
              </p>
            </div>
            ...
            <div className="w-full max-w-[280px] bg-zinc-800/80 h-2 rounded-full overflow-hidden relative">
              <div 
                className="bg-[#F97316] h-full rounded-full transition-all duration-1000 ease-linear" 
                style={{ width: `${(countdown / 10) * 100}%` }}
              />
            </div>

            <div className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest leading-none">
              Closing automatically in <span className="text-[#F97316] font-black text-sm">{countdown}</span> seconds
            </div>
          ...
          <>
            {/* Header Section */}
            <div className="bg-[#F97316] p-8 text-center relative">
              <button 
              ...
              <div className="w-20 h-20 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-6 border-4 border-white/30 shadow-lg">
                 <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center">
                    <Check size={28} className="text-[#F97316]" strokeWidth={4} />
                 </div>
              </div>
              
              <DialogTitle className="text-2xl font-black text-white m-0 leading-tight">
                 {type === 'edit' ? 'Return Updated Successfully!' : 'Return Created Successfully!'}
              </DialogTitle>
            ...
            <div className="p-8 space-y-6">
               ...
               <div className="flex justify-between items-end">
                  ...
                  <div className="flex flex-col items-end gap-1">
                     <span className="text-[10px] font-black text-zinc-500 uppercase tracking-widest">Debit Amount</span>
                     <span className="text-3xl font-black text-[#F97316] tracking-tighter italic">
               ...
               {/* Discount Box */}
               <div className="bg-[#F97316]/5 border border-[#F97316]/30 p-5 rounded-2xl flex justify-between items-center group hover:bg-[#F97316]/10 transition-all">
                  <span className="text-xs font-black text-[#F97316] uppercase tracking-widest leading-none">Total Discount</span>
               ...
               <div className="grid grid-cols-2 gap-3 pt-2">
                  ...
                  <Button 
                    ...
                    className="h-14 rounded-2xl bg-[#F97316] text-white font-black uppercase text-[10px] tracking-widest gap-3 hover:bg-[#EA580C] shadow-xl shadow-orange-500/20 active:scale-95 transition-all"
                  >
                     <Layout size={18} />
                     A4 Print
                  </Button>
                  ...
                  <Button 
                    onClick={() => window.open(`/purchase-return/${saleId}/show`, '_blank')}
                    variant="outline" 
                  ...
                  <Button 
                    onClick={onReturn}
                    className="h-14 rounded-2xl border border-orange-500/30 bg-transparent text-orange-500 font-black uppercase text-[10px] tracking-widest gap-3 hover:bg-orange-50/10 hover:border-orange-500 transition-all group"
                  >
                     {type === 'edit' ? (
                        <>
