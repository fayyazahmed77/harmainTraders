                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-2 px-1 py-3 border-b border-zinc-200 dark:border-zinc-800 text-xs print:hidden">
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-black dark:text-white font-extrabold min-w-[90px]">Supplier:</span>
                                <span className="text-black dark:text-white font-black uppercase">{returnData.supplier?.title || "N/A"}</span>
                            </div>
                            <div className="flex items-center gap-2">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                                    ...
                                    <div className="space-y-12">
                                        ...
                                        <div className="text-xs font-bold text-zinc-500">
                                            Original Invoice Ref: <span className="font-mono text-zinc-800 dark:text-zinc-200 uppercase ml-1">{returnData.original_invoice || "Manual Return"}</span>
                                        </div>
                                        <div className="pt-4">
