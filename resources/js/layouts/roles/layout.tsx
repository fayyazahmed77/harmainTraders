...
export default function RolesLayout({ children }: PropsWithChildren) {
    ...
    return (
        <div className="flex-1 w-full h-full overflow-y-auto bg-zinc-50 dark:bg-zinc-950 custom-scrollbar">
            <div className="max-w-[1600px] mx-auto p-4 md:p-8 space-y-8">
                ...
                <div className="flex flex-col space-y-8 lg:flex-row lg:space-y-0 lg:space-x-8 pb-20">
