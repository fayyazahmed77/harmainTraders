...
export function DataTable({ data }: DataTableProps) {
    ...
    const [selectedBooker, setSelectedBooker] = useState<Booker | null>(null);
    ...
    const handleDelete = () => {
        ...
        router.delete(`/bookers/${selectedBooker.id}`, {
            onSuccess: () => {
                toast.success("Booker deleted successfully!");
    ...
    // table columns
    const columns: ColumnDef<Booker>[] = [
        {
            accessorKey: "name",
            header: "Booker Name",
            cell: ({ row }) => {
    ...
    return (
        <div className="w-full">
            ...
            <Dialog open={openDeleteDialog} onOpenChange={setOpenDeleteDialog}>
                <DialogContent>
                    <DialogHeader>
                        <DialogTitle>Delete Booker</DialogTitle>
                        <DialogDescription>
                            Are you sure you want to delete <strong>{selectedBooker?.name}</strong>?
                        </DialogDescription>
                    </DialogHeader>
