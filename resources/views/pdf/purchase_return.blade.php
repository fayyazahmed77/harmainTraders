        ...
        <table class="banner-table">
            <tr>
                ...
                <td style="text-align: center; vertical-align: middle; padding: 0 15px;">
                    <div class="invoice-text">PURCHASE RETURN</div>
                </td>
                <td style="width: 30%; vertical-align: middle;">
                    <div style="border-bottom: 2px solid #000; width: 100%;"></div>
                </td>
    ...
    <div class="content-padding">
        ...
        <div class="info-section clearfix">
            <div class="invoice-to-wrapper">
                <div class="customer-name">Supplier Name : {{ $purchaseReturn->supplier->title }}</div>
                <div class="customer-address">
                    Address : {{ $purchaseReturn->supplier->address1 ?? 'N/A' }}
                </div>
                <div class="customer-address" style="font-weight: bold; color: #222; margin-top: 2px;">
                    Reference Invoice : {{ $purchaseReturn->original_invoice }}
                </div>
            </div>
            <div class="invoice-details-wrapper">
                <table class="details-table" align="right">
                    <tr>
                        <td class="detail-label-cell">Registry No :</td>
                        <td class="detail-value-cell">{{ $purchaseReturn->invoice }}</td>
                    </tr>
                    <tr>
                        <td class="detail-label-cell">Return Date :</td>
                        <td class="detail-value-cell">{{ strtoupper(\Carbon\Carbon::parse($purchaseReturn->date)->format('d M y')) }}</td>
                    </tr>
                    <tr>
                        <td class="detail-label-cell">Officer :</td>
                        <td class="detail-value-cell">{{ $purchaseReturn->salesman->name ?? 'Standard' }}</td>
                    </tr>
                </table>
            </div>
        </div>
        ...
        <div class="footer-section clearfix">
            <div class="footer-left">
                <div style="font-weight: bold; margin-bottom: 25px; font-size: 10px;">
                    Items Dispatched : &nbsp; {{ $purchaseReturn->items->count() }}
                </div>
