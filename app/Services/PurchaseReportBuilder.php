...
class PurchaseReportBuilder
{
    ...
    /**
     * Sort purchase report data based on chosen filter.
     */
    private function sortData($data, $sortBy)
    {
        ...
        switch ($sortBy) {
            ...
            case 'date_desc':
                return $collection->sortByDesc(function ($item) {
                    return $item['date'] ?? $item['month_key'] ?? '';
                })->values()->toArray();
            case 'date_asc':
                return $collection->sortBy(function ($item) {
                    return $item['date'] ?? $item['month_key'] ?? '';
            ...
            case 'area_name_asc':
                return $collection->sortBy('area_name', SORT_NATURAL | SORT_FLAG_CASE)->values()->toArray();
            case 'area_name_desc':
                return $collection->sortByDesc('area_name', SORT_NATURAL | SORT_FLAG_CASE)->values()->toArray();
            case 'total_purchase_desc':
                return $collection->sortByDesc('total_purchase')->values()->toArray();
            case 'total_purchase_asc':
                return $collection->sortBy('total_purchase')->values()->toArray();
            case 'total_payment_desc':
                return $collection->sortByDesc('total_payment')->values()->toArray();
            case 'total_payment_asc':
                return $collection->sortBy('total_payment')->values()->toArray();
            case 'balance_desc':
